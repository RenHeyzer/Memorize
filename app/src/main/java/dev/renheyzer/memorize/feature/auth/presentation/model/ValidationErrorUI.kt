...
fun ValidationError.toUI(): ValidationErrorUI = ValidationErrorUI(
    email = if (this.email) UiText.StringResource(R.string.error_email_invalid) else null,
    ...
    confirmPassword = if (this.password == PasswordError.MISMATCH) UiText.StringResource(R.string.error_password_match) else null
)