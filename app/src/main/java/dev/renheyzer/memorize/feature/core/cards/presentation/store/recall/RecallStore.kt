...
sealed interface RecallIntent {
    ...
    data object OnBackClicked : RecallIntent
    data object ExitConfirmed : RecallIntent
    data object ExitDismissed : RecallIntent
}
